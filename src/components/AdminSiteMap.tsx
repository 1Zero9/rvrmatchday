/**
 * Admin Site Map Component
 * 
 * © 2025 OneZeroNine Premium Football Club Template
 * Developer: OneZeroNine (onezeronine@gmail.com)
 * AI Collaboration: Claude (Anthropic)
 * 
 * Site map component for admin dashboard without layout wrapper.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h3 className="text-xl font-bold text-gray-900 mb-6">Site Overview</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-red-600 mb-2">{pages.filter(p => p.status === 'missing').length}</div>
