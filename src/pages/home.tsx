      ...
      <div className="block md:hidden">
        ...
        <section className="p-6 bg-gray-50 min-h-screen">
          ...
          <div className="space-y-4 mb-8">
            {[
              { href: "/matchday", title: "Match Day", subtitle: "Today's fixtures & results" },
              { href: "/teams/boys", title: "Our Teams", subtitle: "All age groups & squads" },
              { href: "/join/trials", title: "Book a Trial", subtitle: "Join our club today" },
              { href: "/about", title: "About the Club", subtitle: "Our history & values" },
              { href: "/contact", title: "Contact Us", subtitle: "Get in touch" }
            ].map((action, index) => (
              <motion.div
                key={action.href}
          ...
          <div className="mb-8 p-5 bg-gradient-to-r from-club-secondary to-club-secondary-light rounded-xl shadow-lg text-white">
            ...
            <Link 
              ...
              className="block bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-4 py-3 rounded-lg transition-all duration-200 text-center font-medium"
            >
