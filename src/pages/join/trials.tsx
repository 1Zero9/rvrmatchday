/**
 * Trials & Registration Page
 * 
 * © 2025 OneZeroNine Premium Football Club Template
 * Developer: OneZeroNine (onezeronine@gmail.com)
 * AI Collaboration: Claude (Anthropic)
 * 
 * Modern glass morphism trials registration with comprehensive form
 * and trial information in unified responsive design.
 */
...
export default function TrialsRegistration() {
  return (
    <GlassPageTemplate
      ...
      subtitle="Ready to join Rivervalley Rangers AFC? Complete your registration and book your trial session"
      icon="🎯"
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <GlassCard intensity="medium" hover={true} className="p-8">
          ...
          <div className="lg:col-span-1">
            ...
            >
              <GlassCard intensity="light" className="p-6">
                ...
                <nav className="space-y-2">
                  <Link href="/join/youth" className="block text-gray-600 hover:text-blue-600 px-3 py-2 rounded hover:bg-gray-50 transition-colors">Youth Membership</Link>
                  <Link href="/join/senior" className="block text-gray-600 hover:text-blue-600 px-3 py-2 rounded hover:bg-gray-50 transition-colors">Senior Membership</Link>
                  <Link href="/join/family" className="block text-gray-600 hover:text-blue-600 px-3 py-2 rounded hover:bg-gray-50 transition-colors">Family Packages</Link>
                  <Link href="/join/academy" className="block text-gray-600 hover:text-blue-600 px-3 py-2 rounded hover:bg-gray-50 transition-colors">Youth Academy</Link>
            ...
            <motion.div
              ...
              className="mb-6"
            >
              <GlassCard intensity="light" className="p-6 bg-gradient-to-br from-blue-50/80 to-purple-50/80">
