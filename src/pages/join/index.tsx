      ...
      */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {joinOptions.map((option, index) => (
            ...
            >
              ...
              >
                ...
                <Link 
                  href={option.href}
                  className="inline-block w-full text-center bg-club-primary text-white py-3 px-6 rounded-lg font-semibold hover:bg-club-secondary transition-colors"
                >
                  Learn More
                </Link>
              </GlassCard>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-club-accent/20 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-club-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <div className="bg-club-secondary/20 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-club-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          ...
          <Link 
            href="/contact"
            className="inline-block bg-club-primary text-white py-3 px-8 rounded-lg font-semibold hover:bg-club-secondary transition-colors"
          >
            Contact Us Today
          </Link>
        </motion.div>
